...
class setting_config:
    ...
    model_config = {
        ...
        # 'depths_decoder': [2,4,2,2],
        'depths_decoder': [2,4,4,2],
        # 'depths_decoder': [2,2,2,1],
        # 'drop_path_rate': 0.2,
        'drop_path_rate': 0.2,
        'load_ckpt_path': 'VM-UNet/pre_trained_weights/vmamba_small_e238_ema.pth',
    }

    datasets = 'isic18' 
    if datasets == 'isic18':
        data_path = 'VM-UNet/data/isic2018/'
    elif datasets == 'isic17':
        data_path = 'VM-UNet/data/isic2017/'
    elif datasets == 'CVC-ClinicDB':
        data_path = 'VM-UNet/data/CVC-ClinicDB/'
    elif datasets == 'polyp':
        data_path = 'VM-UNet/data/polyp/'
    elif datasets == 'kvasir':
         data_path = 'VM-UNet/data/kvasir/'
    else:
